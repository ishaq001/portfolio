    ...
    <section className='w-full pt-20 '>
      ...
      <div className='my-20 flex flex-col lg:flex-row items-center justify-center  gap-4'>
        <Card
          ...
          description='We"ll collaborate to map out your website"s goals, target audience, and key functionalites. We will discuss things like site structure, navigation and content requirements.'
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description='Once we agree on the plan, I cue my lofi playlist and into coding. From initial sketches to polished code, I keep you updated every step of the way.'
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          description='This is where the magic happens! Based on the approved design, I will translate everything into functional code, building your website from the ground.'
